...
The Console also serves as a log viewer, displaying messages generated by event handlers and system operations (save, load, synchronization). Log entries are timestamped and color-coded by severity.
