...
<video controls preload="metadata" width="100%" poster="/videos/tutorial-03-data-manager-poster.jpg" src="/videos/tutorial-03-data-manager.mp4">
  Your browser does not support the video element. <a href="/videos/tutorial-03-data-manager.mp4">Download the video</a>.
</video>

The video (under three minutes) shows the creation steps at speed. Use it as a preview, then follow the text.

![The Data Manager on the People model: the Person row expanded into its neighborhood, the form below](./images/tutorial-03-entity-table.png)
...
![The New Entity dialog](./images/tutorial-03-new-entity.png)
...
![The New Attribute dialog, opened from the ownedAttributes section](./images/tutorial-03-new-attribute.png)
...
![The New Relationship dialog with the entity pickers](./images/tutorial-03-new-relationship.png)
...
![The delete dialog with the cascade and the referencing relationship](./images/tutorial-03-delete-dialog.png)
