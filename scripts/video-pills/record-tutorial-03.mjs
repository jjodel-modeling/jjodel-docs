// Video pill recorder for Tutorial 3 (Populating a Model with the Data Manager).
...
<div style="text-align:center"><img src="data:image/png;base64,${fs.readFileSync(LOGO).toString('base64')}" style="width:260px;margin-bottom:34px" alt="Jjodel"/><div style="font-size:20px;letter-spacing:.2em;color:#7dd3fc;margin-bottom:18px">TUTORIAL 3</div>
