...
<div style="font-size:56px;font-weight:700;line-height:1.15">Working with Jjodie</div>
<div style="font-size:22px;color:#cbd5e1;margin-top:30px">A metamodel from a sentence, an element explained, the project documented</div>
...
await p.screenshot({path:'tutorial-04-jjodie-poster.jpg', type:'jpeg', quality:85}); await p.evaluate(()=>{ const d=[...document.querySelectorAll('div')].pop().parentElement; d.remove(); }); await p.screenshot({path:'title-tutorial-04.png'}); await b.close();
