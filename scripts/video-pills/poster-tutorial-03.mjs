// Renders the title card of tutorial 3: poster JPEG for the <video> element and title PNG for compose.py.
...
<div style="text-align:center"><img src="data:image/png;base64,${logo}" style="width:260px;margin-bottom:34px"/><div style="font-size:20px;letter-spacing:.2em;color:#7dd3fc;margin-bottom:18px">TUTORIAL 3</div>
...
await p.screenshot({path:'tutorial-03-data-manager-poster.jpg', type:'jpeg', quality:85}); await p.evaluate(()=>{ const d=[...document.querySelectorAll('div')].pop().parentElement; d.remove(); }); await p.screenshot({path:'title-tutorial-03.png'}); await b.close();
